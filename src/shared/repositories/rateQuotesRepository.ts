...
import type { RateCalculationInput, RateCalculationResult, SavedRateQuote } from '@/shared/types';

export interface RateQuotesRepository {
  fetchSavedQuotes(userId?: string): Promise<SavedRateQuote[]>;
  saveQuote(
    userId: string,
    clientName: string,
...
export function createRateQuotesRepository(client?: SupabaseClient): RateQuotesRepository {
