...
import { Sparkles, LayoutDashboard, Globe, Zap, Bell, User, Database } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const initials = user?.channelName
    ? user.channelName.substring(0, 2).toUpperCase()
    : user?.displayName
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="flex items-center space-x-2 pl-2 border-l border-slate-800">
              ...
              <button
                ...
                title="Account & Supabase Settings"
              >
                ...
                <div className="text-left hidden md:block">
                  <div className="text-xs font-semibold text-white leading-tight">
                    {user?.channelName || user?.displayName || 'Demo Creator'}
                  </div>
                  <div className="text-[10px] text-slate-400 font-mono flex items-center space-x-1">
                    ...
                    <span>{isConfigured ? 'Supabase' : 'Demo'}</span>
                  </div>
                </div>
              </button>
            </div>
