...
import { mockChannelPatterns } from '../../data/mockData';

export const CreatorScientist: React.FC = () => {
  ...
  // Simple scoring against the pattern rules
  let score = 50;
  if (testLength >= 18 && testLength <= 32) score += 20;
  if (testHookTime <= 2) score += 15;
  if (testHasFace) score += 10;
  if (testHasTextOverlay) score += 10;
  if (testHasIntroBumper) score -= 30;
